...
<div class="card">
  ...
  <div class="card-datatable table-responsive pt-0">
    <table class="datatables-contactshow table">
      <thead>
        <tr>
        <th>#</th>
        <th>Name</th>
...
$(document).ready(function() {
    var contactshowViewRoute = "{{ route('view-contactshow', ':id') }}";
    
    var contactshowTable = $('.datatables-contactshow').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('contactshow-list') }}",
            type: 'POST',
            headers: {
    ...
    render: function(data, type, row) {
        ...
        return 'N/A';
            ...
            },
            {
                ...
                name: 'action',
                render: function (data, type, row) {
                    var viewButton = `<a href="${contactshowViewRoute.replace(':id', data)}" 
                                       type="button" 
