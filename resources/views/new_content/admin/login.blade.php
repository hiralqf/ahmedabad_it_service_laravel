        ...
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center mt-2">
            <a href="{{url('/')}}" class="app-brand-link gap-2">
              <span class="app-brand-logo demo" id="app-brand-logo"><img src="{{ asset('frontend/images/Chamunda Industries - Logo.png')}}" class="logoVertical"  alt=""></span>
              <!-- <span class="app-brand-text demo text-body fw-bold ms-1">{{config('variables.templateName')}}</span> -->
            </a>
          </div>
          <!-- /Logo -->
          <h4 class="mb-1 pt-2">Welcome to Chamunda Industries tech Pvt. Ltd. 👋</h4>
